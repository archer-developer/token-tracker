# Персональный трекер коммерческих токенов Беларуси
...
Персональный трекер для токенов преобретенных на платформах Fainex/Finstore/Bynex.

## ✨ Основные функции

- 💾 **Полностью локально** — все данные хранятся в браузере (IndexedDB)
- 📊 **Агрегированные метрики** — XIRR, P&L, текущие убытки, прогнозы
- 💼 **Управление портфелем** — добавление инструментов, управление дефолтами, отслеживание выплат
...
- 🌍 **Мультиязычность** — русский и белорусский
